 ...
 */
public interface IMessage extends StanzaListener, MessageListener, IEmployee, OnUpdate,HandlerMessageLeader{
     ...
     */
    void registerOnMessageReceiver(OnChatMessageReceiver onChatMessageReceiver);
