...
public class RoundedImageView extends ImageView {
	...
	public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ImRoundedImageView, defStyle, 0);

		int index = a.getInt(R.styleable.ImRoundedImageView_android_scaleType, -1);
		if (index >= 0) {
		...
		mCornerRadius = a.getDimensionPixelSize(R.styleable.ImRoundedImageView_corner_radius, -1);
		mBorderWidth = a.getDimensionPixelSize(R.styleable.ImRoundedImageView_im_border_width, -1);
		...
		mBorderColor = a.getColorStateList(R.styleable.ImRoundedImageView_im_border_color);
		if (mBorderColor == null) {
			mBorderColor = ColorStateList.valueOf(RoundedDrawable.DEFAULT_BORDER_COLOR);
		}

		mMutateBackground = a.getBoolean(R.styleable.ImRoundedImageView_mutate_background, false);
		mOval = a.getBoolean(R.styleable.ImRoundedImageView_oval, false);
