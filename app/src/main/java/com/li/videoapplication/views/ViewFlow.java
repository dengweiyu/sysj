...
public class ViewFlow extends AdapterView<Adapter> {
	...
	public static interface ViewSwitchListener {
		 ...
		 * @param position
		 *            The checkPosition in the adapter of the
	 ...
	 * 是否自动播放标志
	 */
	private boolean isAutoFlowTimer = false;

	public boolean isAutoFlowTimer() {
		return isAutoFlowTimer;
	}
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_DOWN:
			/*
			 * If being flinged and user touches, stopRequestService the fling. isFinished
	...
	private void postViewSwitched(int direction) {
		...
		if (direction > 0) { // to the right
			...
			// if(direction > 1) {
			// mCurrentAdapterIndex += mAdapter.getFileCount() - 2;
			// mCurrentBufferIndex += mAdapter.getFileCount() - 2;
			// }
