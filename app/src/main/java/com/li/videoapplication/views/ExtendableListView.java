...
public abstract class ExtendableListView extends AbsListView {
    ...
    /**
     * A class that represents a fixed view in a data, for example a header at the top
     * or a footer at the bottom.
     */
    public class FixedViewInfo {
        /**
         * The view to imageupload_add to the data
         */
        public View view;
        /**
        ...
        public Object data;
        /**
         * <code>true</code> if the fixed view should be selectable in the data
         */
    ...
    public ExtendableListView(final Context context, final AttributeSet attrs, final int defStyle) {
        ...
        // startCollectionActivity our layout mode drawing from the top
    ...
    protected void onFocusChanged(boolean gainFocus, int direction, Rect previouslyFocusedRect) {
        // TODO : handle focus and its impact on selection - if we imageupload_add item selection support
    }
    ...
    public void setAdapter(final ListAdapter adapter) {
        ...
        // use a wrapper data adapter if we have a header or footer
    ...
    /**
     * Add a fixed view to appear at the top of the data. If addHeaderView is
     ...
     * views.
     *
     * @param v            The view to imageupload_add.
    ...
    public void addHeaderView(View v, Object data, boolean isSelectable) {
        ...
        if (mAdapter != null && !(mAdapter instanceof HeaderViewListAdapter)) {
            throw new IllegalStateException(
                    "Cannot imageupload_add header view to data -- setAdapter has already been called.");
        }
    ...
    /**
     * Add a fixed view to appear at the bottom of the data. If addFooterView is
     * called more than once, the views will appear in the order they were
     * added. Views added using this call can take focus if they want.
     * <p>
     * NOTE: Call this before calling setAdapter. This is so ListView can wrap
    ...
    public void addFooterView(View v, Object data, boolean isSelectable) {
        ...
        // relying on being able to imageupload_add a footer and then calling setAdapter to
    ...
    /**
     * Add a fixed view to appear at the bottom of the data. If addFooterView is called more
    ...
    protected void layoutChildren() {
        ...
        try {
            ...
            // our last state so we keep our checkPosition
            ...
            // safety check!
            // Handle the tipEmpty set by removing all views that are visible
    ...
    protected void handleDataChanged() {
        ...
        // TODO : imageupload_add selection handling here
    }
...
//                }
    ...
    private boolean onTouchDown(final MotionEvent event) {
        ...
        // TODO : use the motion checkPosition for fling support
...
//            case TOUCH_MODE_OVERSCROLL:
        ...
        if (mTouchMode == TOUCH_MODE_SCROLLING) {
            ...
            if (y != mLastY) {
                ...
                if (mMotionPosition >= 0) {
                    ...
                    // If we don't have a motion checkPosition that we can reliably track,
    ...
    // Move our views and implement view recycling to startVideoMangerActivity new views if necessary
    ...
    private boolean moveTheChildren(int deltaY, int incrementalDeltaY) {
        ...
        if (count > 0) {
            if (DBG) Log.d(TAG, "scrap - detachViewsFromParent startCollectionActivity:" + start + " count:" + count);
    ...
    protected void fillGap(boolean down) {
        ...
        if (down) {
            // fill down from the top of the checkPosition below our last
            int position = mFirstPosition + count;
            final int startOffset = getChildTop(position);
            fillDown(position, startOffset);
        } else {
            // fill up from the bottom of the checkPosition above our first.
    ...
    private View fillDown(int pos, int nextTop) {
        ...
        while ((nextTop < end || hasSpaceDown()) && pos < mItemCount) {
            // TODO : imageupload_add selection support
    ...
    private View fillUp(int pos, int nextBottom) {
        if (DBG) Log.d(TAG, "fillUp - checkPosition:" + pos + " nextBottom:" + nextBottom);
        View selectedView = null;
        ...
        while ((nextBottom > end || hasSpaceUp()) && pos >= 0) {
            ...
            if (DBG) Log.d(TAG, "fillUp next - checkPosition:" + pos + " nextBottom:" + nextBottom);
        }
    ...
    /**
     * Fills the data from top to bottom, starting with mFirstPosition
     */
    ...
    private View fillSpecific(int position, int top) {
        ...
        // Possibly changed again in fillUp if we imageupload_add rows above this one.
        ...
        // This will correct for the top of the first view not touching the top of the data
        adjustViewsUpOrDown();
    ...
    private View makeAndAddView(int position, int y, boolean flowDown, boolean selected) {
        ...
        if (!mDataChanged) {
            // Try to use an existing view for this checkPosition
        ...
        // Make a new view for this checkPosition, or convert an unused view if possible
     ...
     * positioned properly.
     *
     * @param child    The view to imageupload_add
     * @param position The checkPosition of this child
     * @param y        The y checkPosition relative to which this view will be positioned
     * @param flowDown If true, align top edge to y. If false, align bottom
     *                 edge to y.
     * @param selected Is this checkPosition selected?
    ...
    private void setupChild(View child, int position, int y, boolean flowDown,
        ...
        if (recycled || (layoutParams.recycledHeaderFooter &&
            ...
            if (DBG) Log.d(TAG, "setupChild attachViewToParent checkPosition:" + position);
            attachViewToParent(child, flowDown ? -1 : 0, layoutParams);
        } else {
            if (DBG) Log.d(TAG, "setupChild addViewInLayout checkPosition:" + position);
        ...
        if (needToMeasure) {
            if (DBG) Log.d(TAG, "setupChild onMeasureChild checkPosition:" + position);
            onMeasureChild(child, layoutParams);
        } else {
            if (DBG) Log.d(TAG, "setupChild cleanupLayoutState checkPosition:" + position);
        ...
        if (DBG) {
            Log.d(TAG, "setupChild checkPosition:" + position + " h:" + h + " w:" + w);
        }
    ...
    /**
     * Measures a child view in the data. Should call
     */
    ...
    /**
     * Get a view and have it startVideoMangerActivity the data associated with the specified
     * checkPosition. This is called when we have already discovered that the view is
     * not available for reuse in the recycle bin. The only choices left are
     * converting an old view or making a new one.
     *
     * @param position The checkPosition to displayText
     * @param isScrap  Array of at least 1 boolean, the first entry will become true if
     *                 the returned view was taken from the scrap heap, false if otherwise.
     * @return A view displaying the data associated with the specified checkPosition
     */
    private View obtainView(int position, boolean[] isScrap) {
        ...
        View child;
        if (scrapView != null) {
            if (DBG) Log.d(TAG, "getView from scrap checkPosition:" + position);
            ...
            if (DBG) Log.d(TAG, "getView checkPosition:" + position);
    ...
    /**
     * Check if we have dragged the bottom of the data too high (we have pushed the
    ...
    private void correctTooHigh(int childCount) {
        ...
        // top of the data to be pushed up.
    ...
    /**
     * Check if we have dragged the bottom of the data too low (we have pushed the
    ...
    private void correctTooLow(int childCount) {
        ...
        // bottom of the data to be pushed down.
        if (mFirstPosition == 0 && childCount > 0) {
            ...
            if (topOffset > 0) {
                if (lastPosition < mItemCount - 1 || lastBottom > end) {
                    ...
                    if (lastPosition < mItemCount - 1) {
                        // Fill the gap that was opened below the last checkPosition with more rows, if
                        // possible
    ...
    /**
     * Override to checkPosition the child as you so wish
     */
     ...
     *
     * @return the left location to layout the child for the given checkPosition
     */
     ...
     *
     * @return the top location to layout the child for the given checkPosition
     */
     ...
     *
     * @return the bottom location to layout the child for the given checkPosition
     */
        ...
        public void run() {
            switch (mTouchMode) {
                ...
                case TOUCH_MODE_FLINGING: {
                    ...
                    // Flip sign to convert finger direction to data items direction
                    // (e.g. finger moving down means data is moving towards the top)
    ...
    /**
     * Update the status of the data based on the tipEmpty parameter.  If tipEmpty is true and
     * we have an tipEmpty view, displayText it.  In all the other cases, make sure that the listView
     * is VISIBLE and that the tipEmpty view is GONE (if it's not null).
     */
    private void updateEmptyStatus() {
        ...
        if (empty) {
            if (emptyView != null) {
                ...
                // If the caller just removed our tipEmpty view, make sure the data view is visible
                setVisibility(View.VISIBLE);
            }

            // We are now GONE, so pending layouts will not be dispatched.
            // Force one here to make sure that the state of the data matches
    ...
    /**
     * Note there's no RecyclerListener. The caller shouldn't have a need and we can imageupload_add it later.
     */
    class RecycleBin {

        /**
         * The checkPosition of the first view stored in mActiveViews.
         */
        private int mFirstActivePosition;

        /**
         * Views that were on screen at the startCollectionActivity of layout. This array is populated at the startCollectionActivity of
         * layout, and at the end of layout all view in mActiveViews are moved to mScrapViews.
         * Views in mActiveViews represent a contiguous range of Views, with checkPosition of the first
         ...
         * @param firstActivePosition The checkPosition of the first view that will be stored in
         *                            mActiveViews
         */
        ...
        /**
         * Get the view corresponding to the specified checkPosition. The view will be removed from
         * mActiveViews if it is found.
         *
         * @param position The checkPosition to look up in mActiveViews
        ...
        /**
         * Put a view into the ScrapViews data. These views are unordered.
         *
         * @param scrap The view to imageupload_add
         */
        void addScrapView(View scrap, int position) {
            if (DBG) Log.d(TAG, "addScrapView checkPosition = " + position);
    ...
    static View retrieveFromScrap(ArrayList<View> scrapViews, int position) {
        ...
        if (size > 0) {
            // See if we still have a view for this checkPosition.
    ...
    /**
     * Position from which to startCollectionActivity looking for mSyncRowId
     */
    ...
    public Parcelable onSaveInstanceState() {
        ...
        if (haveChildren && mFirstPosition > 0) {
            // Remember the checkPosition of the first child.
            // We only do this if we are not currently at the top of
            // the data, for two reasons:
            // (1) The data may be in the process of becoming tipEmpty, in
            // which case mItemCount may not be 0, but if we try to
            // ask for any information about checkPosition 0 we will crash.
            // (2) Being "at the top" seems like a special case, anyway,
            // and the user wouldn't expect to end up somewhere else when
            // they revisit the data even if its content has changed.
            View v = getChildAt(0);
            ss.viewTop = v.getTop();
