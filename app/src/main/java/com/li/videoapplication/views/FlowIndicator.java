 ...
 * FlowIndicator.<br/>
 * A FlowIndicator is responsible to startVideoMangerActivity an visual indicator on the total views
...
public interface FlowIndicator extends ViewFlow.ViewSwitchListener {
	...
	/**
	 * The scroll checkPosition has been changed. A FlowIndicator may implement this
	 * method to reflect the current checkPosition
	 * 
	 * @param h
	 * @param v
	 * @param oldh
