...
public class ZoomableImageView extends View {
	...
	// This is the base transformation which is used to startVideoMangerActivity the image
	// initially. The current computation for this shows the image in
	// it's entirety, letterboxing as needed. One could chose to
	// startVideoMangerActivity the image as cropped instead.
	//
	...
	// The maxView zoom for the view, determined programatically
	...
	private void init(Context context) {
		...
		// Setup the refreshStorge runnable
	...
	// is calculated to startVideoMangerActivity
