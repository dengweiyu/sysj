 ...
 * </ul>
 * <ul>
 * inactiveType: Define how to draw the inactive circles, either helpquestion_bg or fill
 * (default to helpquestion_bg)
 * </ul>
 * <ul>
 * activeType: Define how to draw the active circle, either helpquestion_bg or fill
 * (default to fill)
 * </ul>
 * <ul>
...
public class CircleFlowIndicator extends View implements FlowIndicator,
	...
	public CircleFlowIndicator(Context context, AttributeSet attrs) {
		...
		// Gets the inactive circle type, defaulting to "helpquestion_bg"
	...
	protected void onDraw(Canvas canvas) {
		...
		// The flow width has been upadated yet. Draw the default checkPosition
	...
	/**
	 * Sets the helpquestion_bg color
	 * 
	 * @param color
	 *            ARGB value for the text
	 */
	...
	private void resetTimer() {
		...
		if (fadeOutTime > 0) {
			...
			if (timer == null || timer._run == false) {
				// Create and startCollectionActivity a new timer
				timer = new FadeTimer();
				timer.execute();
			} else {
