...
/**
 * 自定义ScrollView 不包含孩子，就是只针对普通的布局
 */
public class ScrollViewY1 extends ScrollView {
	...
	public ScrollViewY1(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	...
	/***
	 * 是否需要移动布局 
	 * inner.getMeasuredHeight():获取的是控件的高度
