 ...
 * 活动：赛事奖金榜
 */
public class MatchRewardBillboardActivity extends TBaseAppCompatActivity implements View.OnClickListener,
        IMatchRewardBillboardView {
    ...
    public void loadData() {
        super.loadData();
        BillboardPresenter presenter = new BillboardPresenter();
        presenter.setMatchRewardBillboardView(this);
        presenter.loadMatchRewardBillboardData();
    }
    ...
    private void initToolBar() {
        ...
        setTextViewText(tb_title, "赛事奖金榜");
    }
    ...
    private void initWebView() {
        ...
        webView.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(String url, String userAgent, String contentDisposition, String mimetype, long contentLength) {
                ...
                try {
                    IntentHelper.startActivityActionView(MatchRewardBillboardActivity.this, url);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
    ...
    public void finish() {
        super.finish();
        overridePendingTransition(R.anim.activity_hold, R.anim.activity_slide_out_left);
    }
