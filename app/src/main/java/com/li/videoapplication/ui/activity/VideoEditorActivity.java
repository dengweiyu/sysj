...
public class VideoEditorActivity extends TBaseActivity implements OnClickListener {
    ...
    private AspectRatioLayout playing_container;
    ...
    private void initVideoView() {
        ...
        videoView.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
            ...
            public void onPrepared(MediaPlayer iMediaPlayer) {
                ...
                textTimeMax.setText(getTimeForTrackFormat(iMediaPlayer.getDuration(), true));
                if (iMediaPlayer.getDuration() >= 10000) {
                    textTimeMin.setText(getTimeForTrackFormat(10000, true));
                } else {
                    textTimeMin.setText(getTimeForTrackFormat(iMediaPlayer.getDuration(), true));
                }
                ...
                startMs = 0;
                endMs = iMediaPlayer.getDuration();

                seekBar.setMaxValue((int) iMediaPlayer.getDuration());
                seekBar.setLeftProgress(0);
                seekBar.setRightProgress((int) iMediaPlayer.getDuration());
    ...
    private void setVideoRatio() {
        ...
        if (playing_container != null)
            playing_container.setAspectRatio(ratio);
    }
