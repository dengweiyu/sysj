...
public class ReplyMessageVideoAdapter extends BaseArrayAdapter<GroupVideoReplyMessage> {
    private String mType;

    public ReplyMessageVideoAdapter(Context context, List<GroupVideoReplyMessage> data, String type) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        final ReplyMessageVideoAdapter.ViewHolder holder;
        if (view == null) {
            holder = new ReplyMessageVideoAdapter.ViewHolder();
            ...
            holder = (ReplyMessageVideoAdapter.ViewHolder) view.getTag();
        }
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ActivityManager.startVideoPlayActivity(getContext(), getVideoImage(record));
                UmengAnalyticsHelper.onEvent(getContext(), UmengAnalyticsHelper.SLIDER, "视频回复消息列表");
            }
        });
     ...
     * 消息是否已读
     */
    private void setCount(final GroupVideoReplyMessage record, final ReplyMessageVideoAdapter.ViewHolder holder) {
    ...
    private VideoImage getVideoImage(GroupVideoReplyMessage record) {
        VideoImage item = new VideoImage();
        item.setMember_id(record.getMember_id());
        item.setAvatar(record.getIcon());
        item.setNickname(record.getMember_name());
        item.setVideo_id(record.getRelation_id());
        item.setId(record.getRelation_id());
