 ...
 * 碎片：风云榜-玩家榜
 */
public class PlayerBillboardFragment extends TBaseChildFragment {
    ...
    protected void initTopMenu(View view) {
        ...
        if (fragments == null) {
            ...
            fragments.add(FansBillboardFragment.newInstance(FansBillboardFragment.PLAYERBILLBOARD_FANS));
            fragments.add(FansBillboardFragment.newInstance(FansBillboardFragment.PLAYERBILLBOARD_RANK));
            fragments.add(FansBillboardFragment.newInstance(FansBillboardFragment.PLAYERBILLBOARD_VIDEO));
        }
        ...
        setTextViewText(topText.get(0), R.string.playerBillboard_left);
        setTextViewText(topText.get(1), R.string.playerBillboard_middle);
        setTextViewText(topText.get(2), R.string.playerBillboard_right);
