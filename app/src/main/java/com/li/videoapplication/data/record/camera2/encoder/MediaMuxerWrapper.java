package com.li.videoapplication.data.record.camera2.encoder;
/*
...
public class MediaMuxerWrapper {
	...
	private static final String DIR_NAME = FileOperateUtil.getVideoFolder();
	...
	public MediaMuxerWrapper() throws IOException {
		try {
			mOutputPath = FileOperateUtil.getVideoPath();
