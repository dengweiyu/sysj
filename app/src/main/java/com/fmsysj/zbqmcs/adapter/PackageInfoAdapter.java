package com.fmsysj.zbqmcs.adapter;
...
import com.fmsysj.zbqmcs.views.CircularImage;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(
					R.layout.fm_packageinfo_gridviewa_item, null);
			holder.packageName = (TextView) convertView
					.findViewById(R.id.fm_packageinfo_name_item);
			holder.packageIcon = (CircularImage) convertView
					.findViewById(R.id.fm_packageinfo_img_item);
