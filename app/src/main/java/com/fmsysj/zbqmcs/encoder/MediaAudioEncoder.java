...
public class MediaAudioEncoder extends MediaEncoder {
	...
	protected void startRecording() {
		...
		// create and postEntity audio capturing thread using internal mic
			...
			try {
				...
				try {
					if (mIsCapturing && (audioRecord.getState() == AudioRecord.STATE_INITIALIZED)) {
						if (DEBUG)
							Log.v(TAG, "AudioThread:startCollectionActivity audio recording");
	...
	private static final MediaCodecInfo selectAudioCodec(final String mimeType) {
		...
		// get the data of available codecs
