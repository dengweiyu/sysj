...
-keep class [com.li.videoapplication].** { *; }
...
# 下面中括号的地方需要要填你的包名
-keep public class [com.li.videoapplication].R$*{
...
-keep class com.li.videoapplication.data.js.** {*;}
#---------------------------------自定义View的类------------------------
#在这下面写自定义View的类的类，没有就去掉这句话！
-keep class com.li.videoapplication.views.**{*;}
