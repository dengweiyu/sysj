...
public class MyPushMessageReceiver extends PushMessageReceiver {
    ...
    public void onBind(Context context, int errorCode, String appid,
        ...
        BaiduEntity baiduEntity = BaiduPush.getInstances().getBaiduEntity();
        baiduEntity.setAppid(appid);
        baiduEntity.setChannelId(channelId);
        baiduEntity.setRequestId(requestId);
        baiduEntity.setUserId(userId);
        baiduEntity.setErrorCode(errorCode);
        BaiduPush.getInstances().succeed();
    }
